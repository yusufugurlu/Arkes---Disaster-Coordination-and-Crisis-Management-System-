<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Site2.Master" AutoEventWireup="true" CodeBehind="wpAddDevice.aspx.cs" Inherits="WebForm.Arkes.wpAddDevice" %>
    ...
    <div class="row g-0">
        ...
        <div class="row gx-3 mt-2">
            ...
            <div class="col-6 mt-3">
                <asp:Button ID="btnSave" OnClick="btnSave_Click" runat="server" CssClass="btn btn-primary w-100 h-100" Text="Kaydet" />
            </div>
        </div>
        <div class="row gx-3">
